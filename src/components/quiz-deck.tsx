...
<button
              onClick={goNext}
              disabled={locked}
              className={`mt-3 w-full rounded-2xl bg-accent px-4 py-4 text-base font-semibold text-accent-foreground shadow-lg shadow-accent/20 transition-opacity ${locked ? "opacity-50" : ""}`}
            >
              Siguiente →
            </button>
